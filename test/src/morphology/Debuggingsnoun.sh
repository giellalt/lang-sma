...
grep ";" ../../../src/morphology/stems/nouns.lexc | egrep -v "(^\!|LexSub)" | grep ' R '| cut -d ":" -f1 | cut -d "+" -f1 | sed 's/$/+N+Cmp#gåetie+N+Sg+Nom/' | $LOOKUP ../../../src/generator-gt-norm.xfst| cut -f2 | sed 's/gåetie//' > Ranalnouns
