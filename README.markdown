...
This directory contains source files for the Southern Sami language
...
-   <https://giellalt.uit.no/lang/sma/j-sma.html> (analyser)
-   <https://giellalt.uit.no/index.html> (infrastructure)

Requirements
------------

In order to compile and use Southern Sami language morphology and
...
The Southern Sami language sources can be acquired using [giella SVN
