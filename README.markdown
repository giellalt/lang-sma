The Southern Sámi morphology and tools
==========================================

This repository contains finite state source files for the Southern Sámi language,
...
for the Southern Sámi language by using the [Divvun Installer](http://divvun.no)
...
In order to compile and use Southern Sámi language morphology and
